...
public class TransactionResourceIntTest {
    ...
    private static final BigDecimal DEFAULT_AMOUNT_IN = new BigDecimal(1);
    private static final BigDecimal UPDATED_AMOUNT_IN = new BigDecimal(2);

    private static final BigDecimal DEFAULT_AMOUNT_OUT = new BigDecimal(1);
    private static final BigDecimal UPDATED_AMOUNT_OUT = new BigDecimal(2);
    ...
    public void setup() {
        ...
        final TransactionResource transactionResource = new TransactionResource(transactionRepository, transactionAmountValidator);
    ...
    public void createTransaction() throws Exception {
        ...
        assertThat(testTransaction.getAmountIn()).isEqualTo(DEFAULT_AMOUNT_IN);
        assertThat(testTransaction.getAmountOut()).isEqualTo(DEFAULT_AMOUNT_OUT);
    ...
    public void getAllTransactions() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].amountIn").value(hasItem(DEFAULT_AMOUNT_IN.intValue())))
            .andExpect(jsonPath("$.[*].amountOut").value(hasItem(DEFAULT_AMOUNT_OUT.intValue())))
    ...
    public void getTransaction() throws Exception {
        ...
        restTransactionMockMvc.perform(get("/api/transactions/{id}", transaction.getId()))
            ...
            .andExpect(jsonPath("$.amountIn").value(DEFAULT_AMOUNT_IN.intValue()))
            .andExpect(jsonPath("$.amountOut").value(DEFAULT_AMOUNT_OUT.intValue()))
    ...
    public void updateTransaction() throws Exception {
        ...
        Transaction testTransaction = transactionList.get(transactionList.size() - 1);
        assertThat(testTransaction.getAmountIn()).isEqualTo(UPDATED_AMOUNT_IN);
        assertThat(testTransaction.getAmountOut()).isEqualTo(UPDATED_AMOUNT_OUT);
