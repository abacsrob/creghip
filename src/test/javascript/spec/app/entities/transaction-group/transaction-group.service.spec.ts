    ...
    describe('TransactionGroup Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transaction-groups';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TransactionGroup', () => {
                service.create(new TransactionGroup(null)).subscribe(received => {
            ...
            it('should update a TransactionGroup', () => {
                service.update(new TransactionGroup(123)).subscribe(received => {
            ...
            it('should return a TransactionGroup', () => {
            ...
            it('should return a list of TransactionGroup', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TransactionGroup(123)]);
            });
