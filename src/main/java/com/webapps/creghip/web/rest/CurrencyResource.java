...
import com.webapps.creghip.repository.CurrencyRepository;
...
public class CurrencyResource {
    ...
    @DeleteMapping("/currencies/batched/{ids}")
    @Timed
    public ResponseEntity<Void> deleteCurrencies(@PathVariable String ids) {
        log.debug("REST request the following Currency ids are marked for deletion: {}", ids);
        List<Currency> currencies = currencyRepository.findAllById(
